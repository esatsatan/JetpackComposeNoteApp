...
import com.example.jetpackcomposenoteapp.util.Constants.MAX_TITLE_LENGHT
...
class SharedViewModel @Inject constructor(
    ...
    //check actions for add,delete,update processesç.
    ...
    private fun addTask() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            // veritabanına todotask nesnesi eklendi.
